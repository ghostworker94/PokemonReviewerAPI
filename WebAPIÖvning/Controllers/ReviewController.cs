...
namespace PokemonReviewApp.Controllers
{
    ...
    public class ReviewController : Controller
    {
        ...
        public ReviewController(IReview reviewRepository, IMapper mapper, IPokemonRepository pokemonRepository, IReviewer reviewerRepository)
        {
        ...
        public IActionResult DeleteReviewsByReviewer(int reviewerId)
        {
            ...
            {
                ModelState.AddModelError("", "ERROR! Try again to delete reviews");
                return StatusCode(500, ModelState);
            }
            return NoContent();
        }
